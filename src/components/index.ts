...
export { default as WrapperContact } from './contact/WrapperContact'
export { default as CallToAction } from './cta/CallToAction'
export { default as Footer } from './footer/Footer'
export { default as ParagraphFooter } from './footer/ParagraphFooter'
...
export { default as WrapperLawCard } from './law-card/WrapperLawCard'
